...
start:
    ...
    add _eax,u64[additional_memory_end]
    sub _eax,u64[additional_memory]
    shr eax,10
    call display_number
...
large_memory:
    ...
    mov u64[memory_start],_eax
    add _eax,u64[memory_end]
    mov u64[memory_end],_eax
    mov u64[additional_memory],_eax
    add u64[additional_memory_end],_eax
    ret
...
exit_program:
    ...
    mov rdx,rdi
    mov rcx,rsi
    call u64[GetEnvironmentVariable]
    add rsp,40
    add edi,eax
...
display_error_line:
    ...
    add esi,16
    mov _edi,u64[additional_memory]
    xor dl,dl
...
dump_preprocessed_source:
    ...
    mov esi,[input_file]
    call copy_asciiz
    cmp _edi,u64[additional_memory_end]
    jae out_of_memory
    mov eax,edi
    sub eax,ebx
    dec eax
...
process_macro:
    ...
    push u64[macro_block_line_number]
    push u64[struc_label]
    push u64[struc_name]
    push _eax
...
macro_instructions_start:
    ...
    mov u64[macro_block_line],_eax
    mov u64[macro_block_line_number],_ecx
    xor eax,eax
    mov u64[counter],_eax
    cmp u64[counter_limit],_eax
...
macro_block_processed:
    ...
    add _esp,24
    pop u64[macro_block_line_number]
    pop u64[macro_block_line]
    pop u64[macro_block]
    pop u64[counter]
...
reverse_counter:
    ...
    continue_block:
    mov _esi,u64[macro_block]
    mov _eax,u64[macro_block_line]
    mov u64[macro_line],_eax
...
negation_ok:
    ...
    mov bh,[value_sign]
    push _eax _edx u64[symbol_identifier] _ebx _ecx
    mov al,[esi]
    or al,al
    jz logical_number
    cmp al,0Fh
...
make_fixups:
    ...
    lea eax,[ecx*5]
    sub esi, eax
    mov u64[free_additional_memory],_esi
...
jmp_far:
    ...
    jne invalid_operand
    mov al,[value_type]
    push _eax u64[symbol_identifier]
    cmp u8 [esi],'.'
    je invalid_value
    mov al,[operand_size]
    cmp al,4
...
take_bnd_mib:
    ...
    jne invalid_operand
    mov al,[address_sign]
    push _eax _ebx _ecx _edx u64[address_symbol]
    call get_address_component
    lods u8 [esi]
    cmp al,']'
    jne invalid_operand
    ...
    jnz invalid_address
    mov [address_register],bh
    pop u64[address_symbol] _edx _ecx _ebx _eax
    mov [address_sign],al
    or bl,bl
    jz mib_place_index
    or bh,bh
...
address_immediate:
    ...
    xchg _ebx,u64[symbol_identifier]
    call mark_relocation
    mov [value_type],al
