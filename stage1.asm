...
init_memory:
	...
	shl	eax,1
	cmp	eax,4000h
	jb allocate_memory_oom
	jmp	allocate_memory
	ret
		
	allocate_memory_oom:
		pushstr 'allocate_memory( out of memory )!'
		jmp	fatal_error
		ret
	
	not_enough_memory_oom:
		pushstr 'not_enough_memory( out of memory )!'
		jmp	fatal_error
		ret
...
get_environment_variable:
	...
	jae get_environment_variable_oom
	ret
		
	get_environment_variable_oom:
		pushstr 'get_environment_variable( out of memory )!'
		jmp	fatal_error
		ret
...
assembler_error:
	...
	line_number_ok_oom:
		pushstr 'dump_symbols( out of memory )!'
		jmp	fatal_error
		ret
...
dump_symbols:
	...
	inc	edi
	cmp	edi,[tagged_blocks]
	jae prepare_external_string_oom
	jmp	prepare_strings_table
	ret
		
	prepare_external_string_oom:
		pushstr 'prepare_external_string( out of memory )!'
		jmp	fatal_error
		ret
	...
	copy_elf_section_name_oom:
		pushstr 'copy_elf_section_name( out of memory )!'
		jmp	fatal_error
		ret
	...
	stos	word [edi]
	cmp	edi,[tagged_blocks]
	jae prepare_default_section_string_oom
	jmp	prepare_strings_table
	ret
		
	prepare_default_section_string_oom:
		pushstr 'prepare_default_section_string( out of memory )!'
		jmp	fatal_error
		ret
	...
	lea	eax,[edi+ecx+1]
	cmp	edi,[tagged_blocks]
	jae label_name_outside_source_oom
	rep	movsb
	xor	al,al
	stosb
      label_dump_name_ok:
	...
	label_name_outside_source_oom:
		pushstr 'label_name_outside_source( out of memory )!'
		jmp	fatal_error
		ret
	...
	pop	_ebx
	cmp	edi,[tagged_blocks]
	jae base_symbol_for_line_ok_oom
	mov	eax,edi
	sub	eax,1Ch
	sub	eax,ebp
	mov	[esi],eax
	...
	base_symbol_for_line_ok_oom:
		pushstr 'base_symbol_for_line_ok( out of memory )!'
		jmp	fatal_error
		ret
	...
	jmp dump_reference_oom
	ret
		
	dump_reference_oom:
		pushstr 'dump_reference( out of memory )!'
		jmp	fatal_error
		ret
...
dump_preprocessed_source:
	...
	jae dump_preprocessed_source_oom
	mov	eax,edi
	sub	eax,ebx
	dec	eax
	mov	[ebx-40h+0Ch],eax
...
preprocessor:
	...
	convert_predefinition_oom:
		pushstr 'convert_predefinition( out of memory )!'
		jmp	fatal_error
		ret
...
preprocess_file:
	...
	mov	byte [edx],1Ah
	sub	edx,ecx
	jc	preprocess_file_oom
	mov	esi,edx
	cmp	edx,edi
	jbe	preprocess_file_oom
	...
	preprocess_file_oom:
		pushstr 'preprocess_file( out of memory )!'
		jmp	fatal_error
		ret
...
convert_line:
	...
	convert_line_data_oom:
		pushstr 'convert_line_data( out of memory )!'
		jmp	fatal_error
		ret
...
add_preprocessor_symbol:
	...
	add_symbol_entry_oom:
		pushstr 'add_symbol_entry( out of memory )!'
		jmp	fatal_error
		ret
	...
	extend_hashes_tree_oom:
		pushstr 'extend_hashes_tree( out of memory )!'
		jmp	fatal_error
		ret
...
process_equ_constants:
	...
	move_data_oom:
		pushstr 'move_data( out of memory )!'
		jmp	fatal_error
		ret
...
do_match:
	...
	free_match_oom:
		pushstr 'free_match( out of memory )!'
		jmp	fatal_error
		ret
...
process_macro:
	...
	process_macro_line_oom:
		pushstr 'process_macro_line( out of memory )!'
		jmp	fatal_error
		ret
	...
	lea	eax,[edi+100h]
	cmp	_eax,cell[memory_end]
	jae process_macro_line_element_oom
	lods	byte [esi]
	cmp	al,'}'
	...
	process_macro_line_element_oom:
		pushstr 'process_macro_line_element( out of memory )!'
		jmp	fatal_error
		ret
...
local_symbols:
	...
	make_local_symbol_oom:
		pushstr 'make_local_symbol( out of memory )!'
		jmp	fatal_error
		ret
...
add_macro_symbol:
	...
	make_macro_symbol_oom:
		pushstr 'make_macro_symbol( out of memory )!'
		jmp	fatal_error
		ret
	...
	add	edx,16
	cmp	edx,[labels_list]
	ja extend_macro_symbol_tree_oom
	xchg	_edx,cell[free_additional_memory]
	xor	eax,eax
	mov	[edx],eax
	mov	[edx+4],eax
	...
	extend_macro_symbol_tree_oom:
		pushstr 'extend_macro_symbol_tree( out of memory )!'
		jmp	fatal_error
		ret
...
parser:
	...
	parser_loop_oom:
		pushstr 'parser_loop( out of memory )!'
		jmp	fatal_error
		ret
...
parse_line_contents:
	...
	parse_argument_oom:
		pushstr 'parse_argument( out of memory )!'
		jmp	fatal_error
		ret
...
get_label_id:
	...
	get_label_id_oom:
		pushstr 'get_label_id( out of memory )!'
		jmp	fatal_error
		ret
	...
	extend_tree_oom:
		pushstr 'extend_tree( out of memory )!'
		jmp	fatal_error
		ret
	...
	label_name_ok_oom:
		pushstr 'label_name_ok( out of memory )!'
		jmp	fatal_error
		ret
...
convert_number:
	...
	cmp	eax,edx
	jae check_memory_for_number_oom
	mov	_eax,_esp
	sub	_eax,cell[stack_limit]
	cmp	eax,100h
	jb	stack_overflow
...
create_addressing_space:
	...
	init_addressing_space_oom:
		pushstr 'init_addressing_space( out of memory )!'
		jmp	fatal_error
		ret
...
assemble_line:
	...
	assemble_line_oom:
		pushstr 'assemble_line( out of memory )!'
		jmp	fatal_error
		ret
	...
	new_line_oom:
		pushstr 'new_line( out of memory )!'
		jmp	fatal_error
		ret
...
display_directive:
	...
	display_directive_oom:
		pushstr 'display_directive( out of memory )!'
		jmp	fatal_error
		ret
	...
	display_next_oom:
		pushstr 'display_next( out of memory )!'
		jmp	fatal_error
		ret
...
show_display_buffer:
	...
	copy_output_path_oom:
		pushstr 'copy_output_path( out of memory )!'
		jmp	fatal_error
		ret
	...
	append_extension_oom:
		pushstr 'append_extension( out of memory )!'
		jmp	fatal_error
		ret
...
virtual_directive:
      ...
      allocate_structure_data:
        ...
        jb allocate_structure_data_oom
        mov     [structures_buffer],ebx
        ret
		
	allocate_structure_data_oom:
		pushstr 'allocate_structure_data( out of memory )!'
		jmp	fatal_error
		ret
	...
	continue_virtual_area_oom:
		pushstr 'continue_virtual_area( out of memory )!'
		jmp	fatal_error
		ret
...
define_data:
	...
	define_data_oom:
		pushstr 'define_data( out of memory )!'
		jmp	fatal_error
		ret
		
	duplicated_values_oom:
		pushstr 'duplicated_values( out of memory )!'
		jmp	fatal_error
		ret
		
      duplicate_single_data_value:
        cmp     edi,[tagged_blocks]
        jae duplicate_single_data_value_oom
        push    _eax _esi
        clc
		call    near cell [_esp+16]
        pop     _ebx _eax
	...
	duplicate_single_data_value_oom:
		pushstr 'duplicate_single_data_value( out of memory )!'
		jmp	fatal_error
		ret
	...
	simple_data_value_oom:
		pushstr 'simple_data_value( out of memory )!'
		jmp	fatal_error
		ret
...
data_bytes:
	...
	get_string_oom:
		pushstr 'get_string( out of memory )!'
		jmp	fatal_error
		ret
...
data_words:
	...
	word_string_oom:
		pushstr 'word_string( out of memory )!'
		jmp	fatal_error
		ret
...
reserve_bytes:
        ...
        mov     edx,ecx
        add     edx,edi
        jc      reserve_bytes_oom
        cmp     edx,[tagged_blocks]
        ja      reserve_bytes_oom
        push    _edi
        cmp     [next_pass_needed],0
        je      zero_bytes
        add     edi,ecx
	...
	reserve_bytes_oom:
		pushstr 'reserve_bytes( out of memory )!'
		jmp	fatal_error
		ret
...
reserve_words:
        ...
        mov     edx,ecx
        shl     edx,1
        jc      reserve_words_oom
        add     edx,edi
        jc      reserve_words_oom
        cmp     edx,[tagged_blocks]
        ja      reserve_words_oom
        push    _edi
        cmp     [next_pass_needed],0
        je      zero_words
        lea     edi,[edi+ecx*2]
	...
	reserve_words_oom:
		pushstr 'reserve_words( out of memory )!'
		jmp	fatal_error
		ret
...
reserve_dwords:
        ...
        mov     edx,ecx
        shl     edx,1
        jc      reserve_dwords_oom
        shl     edx,1
        jc      reserve_dwords_oom
        add     edx,edi
        jc      reserve_dwords_oom
        cmp     edx,[tagged_blocks]
        ja      reserve_dwords_oom
        push    _edi
        cmp     [next_pass_needed],0
        je      zero_dwords
        lea     edi,[edi+ecx*4]
	...
	reserve_dwords_oom:
		pushstr 'reserve_dwords( out of memory )!'
		jmp	fatal_error
		ret
...
reserve_pwords:
	...
	reserve_pwords_oom:
		pushstr 'reserve_pwords( out of memory )!'
		jmp	fatal_error
		ret
...
reserve_qwords:
	...
	reserve_qwords_oom:
		pushstr 'reserve_qwords( out of memory )!'
		jmp	fatal_error
		ret
...
reserve_twords:
	...
	reserve_twords_oom:
		pushstr 'reserve_twords( out of memory )!'
		jmp	fatal_error
		ret
...
align_directive:
      ...
      make_alignment:
        ...
        mov     edx,ecx
        add     edx,edi
        jc make_alignment_oom
        cmp     edx,[tagged_blocks]
        ja make_alignment_oom
        push    _edi
        cmp     [next_pass_needed],0
        je      nops
        add     edi,ecx
	...
	make_alignment_oom:
		pushstr 'make_alignment( out of memory )!'
		jmp	fatal_error
		ret
...
calculate_expression:
	...
	calculation_loop_oom:
		pushstr 'calculation_loop( out of memory )!'
		jmp	fatal_error
		ret
      ...
      store_label_reference:
        ...
        sub     eax,8+4
        cmp     eax,edi
        jbe store_label_reference_oom
        mov     [tagged_blocks],eax
        mov     [eax],ebx
      label_reference_ok:
        ret
	
	store_label_reference_oom:
		pushstr 'store_label_reference( out of memory )!'
		jmp	fatal_error
		ret
...
expand_path:
	...
	expand_path_oom:
		pushstr 'expand_path( out of memory )!'
		jmp	fatal_error
		ret
...
formatter:
	...
	duplicate_output_path_oom:
		pushstr 'duplicate_output_path( out of memory )!'
		jmp	fatal_error
		ret
	
	extension_found_oom:
		pushstr 'extension_found( out of memory )!'
		jmp	fatal_error
		ret
	...
	output_path_ok_oom:
		pushstr 'output_path_ok( out of memory )!'
		jmp	fatal_error
		ret
...
public_directive:
	...
	public_label_oom:
		pushstr 'public_label( out of memory )!'
		jmp	fatal_error
		ret
...
extrn_directive:
	...
	extrn_allowed_oom:
		pushstr 'extrn_allowed( out of memory )!'
		jmp	fatal_error
		ret
...
mark_mz_relocation:
      ...
      mz_relocation_ok:
        add     ebx,4
        cmp     ebx,[structures_buffer]
        jae mz_relocation_ok_oom
        mov     cell[free_additional_memory],_ebx
        pop     _ebx _eax
        ret
	
	mz_relocation_ok_oom:
		pushstr 'mz_relocation_ok( out of memory )!'
		jmp	fatal_error
		ret
...
make_stub:
	...
	stub_from_file_oom:
		pushstr 'stub_from_file( out of memory )!'
		jmp	fatal_error
		ret
	
	stub_header_size_ok_oom:
		pushstr 'stub_header_size_ok( out of memory )!'
		jmp	fatal_error
		ret
	...
	binary_heap_ok_oom:
		pushstr 'binary_heap_ok( out of memory )!'
		jmp	fatal_error
		ret
...
format_pe:
      ...
      reserve_space_for_section_headers:
        ...
        sub     eax,ecx
        cmp     edi,eax
        jae reserve_space_for_section_headers_oom
        shr     ecx,2
        xor     eax,eax
        rep     stos dword [edi]
        mov     eax,edi
	...
	reserve_space_for_section_headers_oom:
		pushstr 'reserve_space_for_section_headers( out of memory )!'
		jmp	fatal_error
		ret
...
mark_pe_relocation:
	...
	pe_relocation_type_ok_oom:
		pushstr 'pe_relocation_type_ok( out of memory )!'
		jmp	fatal_error
		ret
...
make_pe_resource:
      ...
      reserve_space_for_resource:
        ...
        cmp     edi,[tagged_blocks]
        ja reserve_space_for_resource_oom
        jmp     resource_done
		ret
	
	reserve_space_for_resource_oom:
		pushstr 'reserve_space_for_resource( out of memory )!'
		jmp	fatal_error
		ret
      ...
      resource_file_alignment_ok:
        ...
        lea     eax,[edx+ecx]
        cmp     eax,[structures_buffer]
        ja resource_file_alignment_ok_oom
        call    read
        jc      invalid_file_format
        mov     edx,[esi]
        add     edx,[esi+12]
	...
	resource_from_file_oom:
		pushstr 'resource_from_file( out of memory )!'
		jmp	fatal_error
		ret
	
	resource_file_alignment_ok_oom:
		pushstr 'resource_file_alignment_ok( out of memory )!'
		jmp	fatal_error
		ret
	...
	resource_headers_ok_oom:
		pushstr 'make_type_name_entry( out of memory )!'
		jmp	fatal_error
		ret
	...
	make_type_id_entry_oom:
		pushstr 'make_type_id_entry( out of memory )!'
		jmp	fatal_error
		ret
      ...
      make_resource_directories:
        ...
        lea     eax,[edi+16]
        cmp     eax,[tagged_blocks]
        jae make_resource_directories_oom
        xor     eax,eax
        stos    dword [edi]
        call    make_timestamp
        stos    dword [edi]
	...
	make_resource_directories_oom:
		pushstr 'make_resource_directories( out of memory )!'
		jmp	fatal_error
		ret
	...
	make_resource_name_entry_oom:
		pushstr 'make_resource_name_entry( out of memory )!'
		jmp	fatal_error
		ret
      ...
      make_resource_id_entry:
        ...
        lea     eax,[edi+8]
        cmp     eax,[tagged_blocks]
        jae make_resource_id_entry_oom
        mov     eax,ebx
        stos    dword [edi]
        xor     eax,eax
        stos    dword [edi]
	...
	make_resource_id_entry_oom:
		pushstr 'make_resource_id_entry( out of memory )!'
		jmp	fatal_error
		ret
      ...
      make_language_directories:
        ...
        lea     eax,[edi+16]
        cmp     eax,[tagged_blocks]
        jae make_language_directories_oom
        xor     eax,eax
        stos    dword [edi]
        call    make_timestamp
        stos    dword [edi]
      ...
      make_language_id_entry:
        ...
        lea     eax,[edi+8]
        cmp     eax,[tagged_blocks]
        jae make_language_id_entry_oom
        mov     eax,ebx
        stos    dword [edi]
        mov     eax,dword [value]
        stos    dword [edi]
	...
	make_language_directories_oom:
		pushstr 'make_language_directories( out of memory )!'
		jmp	fatal_error
		ret
	
	make_language_id_entry_oom:
		pushstr 'make_language_id_entry( out of memory )!'
		jmp	fatal_error
		ret
	...
	copy_string_data_oom:
		pushstr 'copy_string_data( out of memory )!'
		jmp	fatal_error
		ret
	...
	make_data_records_oom:
		pushstr 'make_data_records( out of memory )!'
		jmp	fatal_error
		ret
	
	update_data_records_oom:
		pushstr 'update_data_records( out of memory )!'
		jmp	fatal_error
		ret
...
format_coff:
	...
	format_coff_oom:
		pushstr 'format_coff( out of memory )!'
		jmp	fatal_error
		ret
...
coff_section:
	...
	coff_section_oom:
		pushstr 'coff_section( out of memory )!'
		jmp	fatal_error
		ret
...
mark_coff_relocation:
	...
	coff_formatter_oom:
		pushstr 'coff_formatter( out of memory )!'
		jmp	fatal_error
		ret
...
coff_formatter:
	...
	add_relocation_oom:
		pushstr 'add_relocation( out of memory )!'
		jmp	fatal_error
		ret
...
format_elf:
	...
	format_elf_oom:
		pushstr 'format_elf( out of memory )!'
		jmp	fatal_error
		ret
	
	elf_header_ok_oom:
		pushstr 'elf_header_ok( out of memory )!'
		jmp	fatal_error
		ret
	...
	format_elf64_oom:
		pushstr 'format_elf64( out of memory )!'
		jmp	fatal_error
		ret
...
elf_section:
	...
	elf_section_oom:
		pushstr 'elf_section( out of memory )!'
		jmp	fatal_error
		ret
